...
Камера, BLE и ML **не используются** — только чип, как в ТЗ проекта.
...
Учебный проект. При публикации на GitHub укажите лицензию (например, **MIT** или **GPL-3.0**) в файле `LICENSE`.
